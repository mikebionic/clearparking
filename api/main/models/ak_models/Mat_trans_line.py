...
class Mat_trans_line(db.Model):
	...
	mat_trans_type_code = db.Column("mat_trans_type_code",db.Integer)
	mat_trans_line_amount_out = db.Column("mat_trans_line_amount_out",db.Integer)
	mat_trans_line_price_out = db.Column("mat_trans_line_price_out",db.Integer)
	mat_trans_line_totalprice = db.Column("mat_trans_line_totalprice",db.Integer)
	mat_trans_line_nettotal = db.Column("mat_trans_line_nettotal",db.Integer)
	mat_trans_line_amount_in = db.Column("mat_trans_line_amount_in",db.Integer)
	mat_trans_line_price_in = db.Column("mat_trans_line_price_in",db.Integer)
	mat_trans_line_totalprice_in = db.Column("mat_trans_line_totalprice_in",db.Integer)
	mat_trans_line_nettotal_in = db.Column("mat_trans_line_nettotal_in",db.Integer)
	...
	mat_trans_line_wh_amount = db.Column("mat_trans_line_wh_amount",db.Integer)
	...
	inv_real_code = db.Column("inv_real_code",db.Integer)
	...
	mat_trans_line_amount_in_onhand = db.Column("mat_trans_line_amount_in_onhand",db.Integer)
	mat_trans_line_outcost = db.Column("mat_trans_line_outcost",db.Integer)
	mat_trans_line_retcost = db.Column("mat_trans_line_retcost",db.Integer)
	mat_trans_line_out_remain_amount = db.Column("mat_trans_line_out_remain_amount",db.Integer)
	mat_trans_line_id_guid = db.Column("mat_trans_line_id_guid",UUID(as_uuid=True),unique=True)
	rep_rate = db.Column("rep_rate",db.Integer)
