...
class Mat_trans_line(db.Model):
	...
	cl_total = db.Column("cl_total",db.Integer)
	cl_type = db.Column("cl_type",db.Integer)
	cl_trans_name = db.Column("cl_trans_name",db.Integer)
	...
	cl_credit = db.Column("cl_credit",db.Integer)
	...
	spe_code = db.Column("spe_code",db.Integer)
	group_code = db.Column("group_code",db.Integer)
	security_code = db.Column("security_code",db.Integer)
	cl_desc = db.Column("cl_desc",db.Integer)
	p_id = db.Column("p_id",db.Integer)
	rep_rate = db.Column("rep_rate",db.Integer)
	rep_debit = db.Column("rep_debit",db.Integer)
	rep_credit = db.Column("rep_credit",db.Integer)
